...
def ensemble_pred(models, textX):
    # Make predictions
    yhats = [model.predict(textX) for model in models]
...
def evaluate_n_models(models, n_member, testX, testy):
    # Select a subset of members
    subset = models[:n_member]
    # Make predictions
...
ensemble_score = evaluate_n_models(models, 2, testX, testy)

"""
From another sour : evalution of model with voting
"""
